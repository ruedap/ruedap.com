...
const products = [
  {
    ...
    image: "static/images/products/daplog.png",
    time: "2013.11.11",
    pubdate: "2013-11-11",
    heading: "Pull RequestとCIを使ったGitHub Flowなブログ環境を作ってみた",
    headingLink: "http://blog.ruedap.com/2013/11/11/github-flow-blog",
    description: '<div><p>今から1年ほど前に、自分でお気に入りのブログ環境を構築する記事が話題になっていて、それを読んだ時から、自分用のブログ環境を作りたいと思っていた。</p><ul><li><a href="http://tech.nitoyon.com/ja/blog/2012/09/20/moved-completed/">俺の最強ブログ システムが火を噴くぜ - てっく煮ブログ</a></li><li><a href="http://webtech-walker.com/archive/2012/09/fired-myblog.html">俺の最強ブログシステムも火を噴いてたぜ - Webtech Walker</a></li></ul><p><span>当時は</span><a href="http://blog.ruedap.com/2013/08/22/imakoko">それどころではなかった</a><span>こともあって、なかなか着手できずにいたんだけど、</span><a href="http://blog.ruedap.com/2013/07/26/reboooot">今年の7月頃</a><span>から作り始めて、最近そこそこ希望通りの形になったので、まだやり残しはたくさんあるけれど、一旦ここで一区切りということでその内容を記事にしてみる。</span></p></div>',
  },
  {
    id: 2,
    name: "Font Awesome Workflow for Alfred 2",
    imageLink: "https://github.com/ruedap/alfred-font-awesome-workflow",
    image: "static/images/products/alfred2-font-awesome-workflow.png",
    time: "2013.8.7",
    pubdate: "2013-08-07",
    heading: "Font Awesomeのアイコンを検索できるAlfred 2のWorkflowを作ってみた",
  ...
  },
  {
    id: 3,
    name: "ウタダヒカループ",
    imageLink: "http://uhloop.com",
    image: "static/images/products/uhloop.png",
    time: "2011.8.11",
    pubdate: "2011-08-11",
    heading: "宇多田ヒカル大好き専用「ウタダヒカループ」を作ってみた",
  ...
  {
    id: 4,
    name: "SASSIENCE ～ 世界が嫉妬するCSSへ",
    imageLink: "http://sassience.com",
    image: "static/images/products/sassience.png",
    time: "2011.5.26",
    pubdate: "2011-05-26",
    heading: "CSSのインデントを綺麗にするサービス「SASSIENCE」を作ってみた",
  ...
  },
  {
    id: 5,
    name: "はてなスターカウンター",
    imageLink: "http://hatenastar.heroku.com/",
    image: "static/images/products/hatenastar.png",
    time: "2011.4.21",
    pubdate: "2011-04-21",
    heading: "はてなスターの総数を表示できる「はてなスターカウンター」を作ってみた",
  ...
  {
    id: 6,
    name: "Inustagram - いぬ大好き専用Instagram",
    imageLink: "http://inustagram.com",
    image: "static/images/products/inustagram.png",
    time: "2011.3.5",
    pubdate: "2011-03-05",
    heading: "二匹目のどじょうを狙っていぬ大好き専用の「Inustagram」を作ってみた",
    headingLink: "http://blog.ruedap.com/entry/20110305/instagram_api_of_exclusive_use_for_dog_lovers_inustagram",
    description: '<div><p>前作ネコスタグラムの公開から約1週間。ビバ土日。2匹目のドジョウを狙って、ネコスタグラム公開後にいただいた反響の中で多かった「犬バージョンはまだ？」というリクエストにおこたえして、いぬ大好き専用Instagramビューアー、イヌスタグラム。</p><p>本家Instagramと一瞬見分けのつかないちょっとグレーなWebアプリ名な上に、前作の検索対象を「cat」から「dog」に変えただけのかんたん複製アプリでございます。</p></div>',
  },
  {
    id: 7,
    name: "Nekostagram - ねこ大好き専用Instagram",
    imageLink: "http://http://nekostagram.com.com",
    image: "static/images/products/nekostagram.png",
    time: "2011.2.28",
    pubdate: "2011-02-28",
    heading: "Instagram APIを使ってねこ大好き専用の「Nekostagram」を作ってみた",
    headingLink: "http://blog.ruedap.com/entry/20110228/instagram_api_of_exclusive_use_for_cat_lovers_nekostagram",
    description: '<div><p>（ドヤッ）ってな感じのWebアプリ名を付けちゃったけど、そんな大層なものではなく、ページを読み込むたびにInstagramのAPIでネコ写真をちょっとずつ取ってきて、そのネコ写真と撮影者のコメントを一覧表示してるだけのペライチなサイトでございます。</p><p>マッタリとかわいいネコたちを見ながら、鼻歌交じりで次へボタンをクリックする感じのネコビューアー。</p></div>',
  },
];
